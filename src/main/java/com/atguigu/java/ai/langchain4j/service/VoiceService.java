...
public class VoiceService {
    ...
    // 在 VoiceService.java 中添加或修改
    public void streamTextToSpeech(String text,
                                   java.util.function.Consumer<ByteBuffer> audioConsumer,
    ...
    // 在 VoiceService.java 中添加此方法
    /**
     * 暴露 NlsClient 给 Handler 使用
     */
    ...
    /**
     * 借鉴你提供的成功代码逻辑，实现 Web 版 TTS
     * 核心：利用 waitForComplete 确保数据完整
     */
