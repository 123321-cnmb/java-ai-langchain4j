...
## 第一阶段：核心对话——AI 怎么“说话”？
项目的入口是 `XiaozhiController.java`，它像一个接线员一样接收用户的请求。
...
## 第三阶段：RAG 知识库——AI 怎么“专业”？

AI 可能会一本正经地胡说八道。为了让它掌握医院内部的专业信息（如神经内科的具体位置），项目引入了 **RAG（检索增强生成）** 流程。
...
这是本项目最智能的地方：**Function Calling（工具调用）**。AI 不止会聊天，还能操作业务系统。
